...
// Get the cookies using Puppeteer within an async context
const getCookies = async () => {
    const cookies = await launchBrowser(); // Call the function to get cookies
    return cookies;
};

const agent = await getCookies().then(cookies => ytdl.createAgent(cookies)); // Wait for cookies to get the agent
